      ...
      <div style={{ display: 'flex', gap: 20 }}>
        <aside className="card" style={{ minWidth: 220, alignSelf: 'flex-start' }}>
          ...
          <nav style={{ display: 'grid', gap: 8 }}>
            ...
            <a href="/admin/brokers"     style={navStyle}>Corretores</a>
            ...
            <a href="/admin/withdrawals" style={{ ...navStyle, color: '#d97706', fontWeight: 600 }}>Retiradas</a>
            ...
            <a href="/admin/intelligence"  style={navStyle}>Inteligencia IA</a>
          </nav>
