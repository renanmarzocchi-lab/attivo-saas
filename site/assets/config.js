window.ATTIVO_CONFIG = {
  ...
  documentDocxUrl: '/documentos/afiliados/programa-afiliados-attivo.docx',
  documentTitle: 'Programa de Afiliados ATTIVO',
  requireDocAcceptance: 'SIM',
  enforceCurrentDocForRelease: 'SIM',
  requireDownloadBeforeRelease: 'SIM',
  embedAppsScriptPanels: 'SIM',
  autoCommissionOnClosedLead: 'SIM'
};
